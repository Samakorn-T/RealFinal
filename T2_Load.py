...
# **Step 2: Load Models**
model_folder = "T2_Folder"
cv_model_path = os.path.join(model_folder, "XGBoost_CV.pkl")
split_model_path = os.path.join(model_folder, "XGBoost_Split.pkl")
...
metadata_df["XGBoost_CV_Predict"] = cv_model.predict(X_scaled)
metadata_df["XGBoost_Split_Predict"] = split_model.predict(X_scaled)

cv_metrics = evaluate_model(y, metadata_df["XGBoost_CV_Predict"], "XGBoost_CV")
split_metrics = evaluate_model(y, metadata_df["XGBoost_Split_Predict"], "XGBoost_Split")
...
plot_results(y, metadata_df["XGBoost_CV_Predict"], "XGBoost_CV", "blue")
plot_results(y, metadata_df["XGBoost_Split_Predict"], "XGBoost_Split", "blue")